...
class StreetFighterCustomWrapper(gym.Wrapper):
    ...
    def step(self, action):
        ...
        curr_player_health = info.get('agent_hp',0)
        curr_oppont_health = info.get('enemy_hp',0)
        ...
        if curr_player_health < 0:
            custom_reward = -math.pow(self.full_hp, (curr_oppont_health + 1) / (self.full_hp + 1))    #Use the remaining health points of opponent as penalty. 
                                            #If the opponent has negative health points, it's a even game and the reward is +1.
            custom_done = True
        ...
        #Game is over and player wins.
            ...
            #Multiply by reward_coeff to make the reward larger than the penalty to avoid agent from avoiding combat.
